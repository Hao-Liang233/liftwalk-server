...
var path="./data.json";
var datainfo={};
var clean={"name":"", "step1_Speed":0, "step1_Hight":0, "step2_Speed":0,
          "step2_Hight":0, "step3_Speed":0, "step3_Hight":0, "delay_time":0,
...
var Host="192.168.208.12"//"192.168.0.14"//"192.168.66.12"//"192.168.1.188"
var Port=5438;

var server = app.listen(Port, Host, function(req, res) { //Host
...
app.post("/control", function(req, res){
  ...
  if(D_ind != -1){
    for(var key in clean){
      if(key != "name")
        datainfo.device[D_ind][key] = req.body[key];
    }
